...
/**
 * GET /api/graviton/confirm-delivery?date=2026-03-28
 *
...
export async function GET(request: Request) {
    try {
        ...
        const { data: pending, error: pendingError } = await gravitonDb
        ...
        const { data: debt, error: debtError } = await gravitonDb
            .from('delivery_debt')
        ...
        const { data: shops, error: shopsError } = await gravitonDb
