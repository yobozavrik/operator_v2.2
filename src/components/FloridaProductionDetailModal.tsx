...
interface FloridaProductionDetailModalProps {
    isOpen: boolean;
    onClose: () => void;
}
...
export const FloridaProductionDetailModal = ({ isOpen, onClose }: FloridaProductionDetailModalProps) => {
    const { data, error, isLoading } = useSWR<ProductionItem[]>(
        isOpen ? '/api/florida/production-detail' : null,
