...
export const FloridaDistributionModal = ({ isOpen, onClose, products }: Props) => {
    ...
    const handleCalculate = async () => {
        ...
        try {
            ...
            for (const p of itemsToProcess) {
                ...
                const response = await fetch('/api/florida/calculate-distribution', {
                    method: 'POST',
    ...
    const handleConfirm = async () => {
        ...
        try {
            const response = await fetch('/api/florida/confirm-distribution', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
