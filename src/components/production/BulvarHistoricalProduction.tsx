            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Аналітика цеху Автовокзал</p>
                    </div>
                </div>
                            ...
                            {data.rows.map((row) => (
                                <div key={row.product_id} className="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-slate-50 transition-colors group">
                                    <div className="col-span-5">
                                        <div className="text-sm font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{row.product_name}</div>
