...
function delta(val: number, unit = '%', invert = false) {
...
function Spark({ data, dataKey, color }: { data: SparkPoint[]; dataKey: keyof SparkPoint; color: string }) {
    return (
...
function RecRow({ rec, onAccept }: { rec: Recommendation; onAccept: () => void }) {
