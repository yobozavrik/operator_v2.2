...
export const GravitonProductionPlanner: React.FC = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Fetch D2 Plan
            const resD2 = await fetch('/api/graviton/plan-d2');
            ...
            // Fetch D3 Critical
            const resCritD3 = await fetch('/api/graviton/critical-d3');
            ...
            // Fetch D3 Plan
            const resD3 = await fetch('/api/graviton/plan-d3');
