...
export const FloridaPowerMatrix = ({ data, onRefresh, initialViewMode = 'products' }: Props) => {
    // STATE
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
                    ...
                    <div className="mt-4 pb-20">
                        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                            <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                                <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 font-[family-name:var(--font-chakra)]">
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    <thead className="bg-slate-50">
                                        <tr className="text-[10px] uppercase tracking-widest text-slate-500 font-[family-name:var(--font-jetbrains)]">
                                    ...
                                    <tbody>
                                        {catalogRows.map((row) => (
                                            <tr key={row.productCode} className="border-t border-slate-100 hover:bg-slate-50/50 transition-colors">
                                                <td className="px-4 py-3 text-slate-500 font-[family-name:var(--font-jetbrains)] text-xs">
                                                    {row.productCode}
                                                </td>
                                                <td className="px-4 py-3 text-slate-900 text-sm font-semibold">
                                                    {row.name}
                                                </td>
                                                ...
                                                <td className="px-4 py-3 text-right text-slate-700 font-[family-name:var(--font-jetbrains)]">
                                                ...
                                                <td className="px-4 py-3 text-right text-blue-600 font-bold font-[family-name:var(--font-jetbrains)]">
                                                    {formatByUnit(row.avgSales, row.unit)}
                                                </td>
                                                <td className="px-4 py-3 text-right">
                                                    <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-slate-100 text-slate-600 text-[10px] font-bold">
                                                        {row.storesCount}
                                                    </span>
                                                </td>
                                            </tr>
