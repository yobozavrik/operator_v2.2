-- Bulvar orders view UTF-8 and category-id stability fix.
-- Why:
-- 1) Existing view text contains mojibake in category literals and may fail to parse.
-- 2) Category-name matching is fragile; for Bulvar we pin by category_id list.
