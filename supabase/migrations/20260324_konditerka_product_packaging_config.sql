create table if not exists konditerka1.product_packaging_config (
    ...
    constraint konditerka_product_packaging_config_weight_bounds_chk
        check (
...
create index if not exists idx_konditerka_product_packaging_config_active
    on konditerka1.product_packaging_config (is_active);

grant select, insert, update, delete on konditerka1.product_packaging_config to service_role;
grant select on konditerka1.product_packaging_config to authenticated;
