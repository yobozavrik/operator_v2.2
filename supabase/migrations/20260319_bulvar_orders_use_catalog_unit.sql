-- Bulvar: move UOM resolution fully into Supabase catalog truth.
-- Source of truth for unit is bulvar1.production_180d_products.unit,
-- which is synced from Poster via poster_weight_flag.
-- This removes heuristic UOM detection from transaction percentiles
-- and eliminates product-specific hotfixes such as product_id=625.
